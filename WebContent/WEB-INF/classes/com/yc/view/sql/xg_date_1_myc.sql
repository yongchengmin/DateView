...
declare
 ...
 begin
  ...
  where t.type = 'CREATE_BOL' and task.status = 'TEST' and task.box_tag is not null
  ...
  loop
    ...
    m11 := m11+1;
    --dbms_output.put_line(re_m_1.m1||':'||re_m_1.m2);
  ...
  close cur1;  
  --dbms_output.put_line(m11||':'||m12||':'||m13||':'||m14);
  ...
  begin
    ...
    COMMIT;
    INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE) VALUES ('任务数',times,m11,1);
    INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE) VALUES ('3分钟以内',times,m12,2);
    INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE) VALUES ('3-5分钟',times,m13,3);
    INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE) VALUES ('5分钟以上',times,m14,4);
    COMMIT;      
  end;
  begin
