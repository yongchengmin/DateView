declare
 ...
 begin
  ...
  begin
    ...
    if m15 > 0 then
      INSERT INTO LEFT_TOP_HEAD_TEMP (TITLE,CATEGORYAXISLABEL,VALUEAXISLABEL,TYPE) VALUES ('装车单未执行监控','','未执行(个)','left_top');
      COMMIT;
      INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE,TYPE) VALUES ('任务数',times,m11,2,'left_top');
      INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE,TYPE) VALUES ('3分钟以内',times,m12,3,'left_top');
      INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE,TYPE) VALUES ('3-5分钟',times,m13,4,'left_top');
      INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE,TYPE) VALUES ('5分钟以上',times,m14,5,'left_top');
      COMMIT;
    else
      INSERT INTO LEFT_TOP_HEAD_TEMP (TITLE,CATEGORYAXISLABEL,VALUEAXISLABEL,TYPE) VALUES ('装车单已完成监控','','执行(个)','left_top');
      COMMIT;
      INSERT INTO LEFT_TOP_Y_TEMP(CATEGORIES,X,QUANTITY,LINE,TYPE) VALUES ('完成任务数',times,m10,1,'left_top');
      COMMIT;
    end if;      
  end;
